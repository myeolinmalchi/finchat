...
from domains.saving.schemas import SavingRateWeights, SavingSearchResult, TotalSavingSearchResult
...
def init_saving_retrieval_tools(collection: AsyncIOMotorCollection):
    ...
    async def find_savings_by_target_and_term(
            params: TargetTermParams) -> TotalSavingSearchResult:
        """
    ...
    async def find_savings_by_monthly_and_term(
            params: MonthlyTermParams) -> TotalSavingSearchResult:
        """
    ...
    async def find_savings_by_target_and_monthly(
            params: TargetMonthlyParams) -> TotalSavingSearchResult:
        """
